...
We anticipate challenges in wrangling our data to find and extract the information that is relevant to our project. Another challenge we will have is how to present our data; choosing types of charts or how we want to set the color and sizes and other details may be difficult. 