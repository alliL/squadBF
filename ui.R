...
shinyUI(navbarPage(
  ...
  tabPanel(
    ...
    fluidPage(
      HTML('<center><img src="https://www.purplepandamedia.com/wp-content/uploads/2015/03/spotify-1.jpg"></center>'),
      p(
        "Using the",
        a("Rspotify",
  ...
  tabPanel(
    ...
    fluidPage(
      ...
      p(
        "From selecting the feature", strong("ENERGY."),
        "we are able to see that most of the song with higher popularity has higher energy."
      ),
      p(
        "However, when selecting", span(strong("popularity")),
        ", we can see that there is an outlier, which is form artist", span(strong("A$AP Rocky."))
      ),
      img(
        src = "https://images.genius.com/0635bd3f246cb6af9c8aa48a06263c39.1000x1000x1.jpg",
      ...
      p(
        "First of all, since it says on", a("Spotify website", href = "https://open.spotify.com/artist/13ubrt8QOOCPljQ2FL1Kca/about"),
  ...
  tabPanel(
    ...
    fluidPage(
      ...
      h3("Allison Lee"),
      img(
        src = "https://i.pinimg.com/736x/31/c3/4f/31c34f9fefbb06074c45434b543f6e11--too-cute-puppies-puppies-cutest.jpg",
        height = 200, width = 200, align = "middle"
      ),
      ...
      h3("Brian Luu"),
      img(
        src = "http://barkingroyalty.com/wp-content/uploads/2015/12/pomeraninan-puppy.jpg?x30644.jpg",
        height = 200, width = 200, align = "middle"
      ),
      ...
      h3("Maggie Wang"),
      img(
        src = "http://vomglockkennel.com/wp-content/gallery/glockqgallery/8.jpg",
        height = 200, width = 200, align = "middle"
      ),
